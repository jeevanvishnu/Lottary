      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-1">
          <div className="flex items-center gap-2 mb-6">
            <div className="bg-gradient-to-br from-[#fbbf24] to-[#d97706] text-[#1a0b2e] p-2 rounded-xl shadow-[0_0_15px_rgba(212,160,23,0.5)]">
              <Box className="w-6 h-6" />
            </div>
            <span className="text-2xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-[#fbbf24] to-amber-300">Jackpot Lottery</span>
          </div>
        ...
        <div>
          ...
          <div className="w-full h-40 bg-[#003344]/40 rounded-xl border border-[#6d28d9]/30 flex items-center justify-center text-[#007A94] shadow-[inset_0_0_20px_rgba(0,95,115,0.1)] hover:border-[#fbbf24]/40 hover:text-[#fbbf24] transition-colors cursor-pointer">
