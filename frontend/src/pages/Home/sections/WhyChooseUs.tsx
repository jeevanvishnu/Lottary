        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 w-full lg:w-auto">
              <a href="tel:6379024854" className="flex items-center gap-4 bg-white p-4 rounded-2xl border border-gray-200 hover:border-[#d97706]/40 transition-all group flex-1 shadow-sm hover:shadow-md">
                ...
                <div>
                  ...
                  <p className="text-[#1a0b2e] font-bold text-lg whitespace-nowrap leading-tight">+91 63790 24854</p>
                  <p className="text-[#1a0b2e]/70 font-medium text-sm whitespace-nowrap leading-tight">+91 63829 32961</p>
                </div>
              </a>
