    ...
    <section className="py-20 px-8 max-w-7xl mx-auto w-full relative z-10">
      <div className="text-center mb-16 relative">
        <h2 className="relative z-10 text-4xl md:text-5xl font-bold mb-4 text-white drop-shadow-md">
          Why <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4A017] to-amber-300">Trust</span> Us
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, index) => (
          <motion.div
            ...
            className="p-8 rounded-3xl bg-[#003344]/30 backdrop-blur-md border border-[#005F73]/25 hover:bg-[#003344]/50 hover:border-[#D4A017]/40 transition-all group shadow-[0_4px_20px_rgba(0,0,0,0.2)]"
          >
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#D4A017]/20 to-[#B8860B]/20 border border-[#D4A017]/30 text-[#D4A017] flex items-center justify-center mb-6 group-hover:scale-110 group-hover:shadow-[0_0_15px_rgba(212,160,23,0.4)] transition-all">
              <feature.icon className="w-8 h-8 drop-shadow-[0_0_8px_currentColor]" />
            </div>
            <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#D4A017] transition-colors">{feature.title}</h3>
