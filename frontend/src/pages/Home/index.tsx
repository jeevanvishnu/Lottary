  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="relative w-full min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#001F2D] to-transparent z-10 pointer-events-none" />
        <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-[#001F2D] to-transparent z-10 pointer-events-none" />
        <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[#001F2D] to-transparent z-10 pointer-events-none" />
        ...
        <main className="relative z-20 flex-1 flex items-center px-8 max-w-7xl w-full mx-auto h-full py-20 lg:py-0">
          ...
          >
            <h1 className="font-bold leading-[1.1] tracking-tight mb-6 text-white drop-shadow-xl">
              ...
              <span className="block text-4xl md:text-5xl lg:text-[4rem] text-transparent bg-clip-text bg-gradient-to-r from-[#D4A017] via-amber-300 to-[#FCEABB] mb-4">Tomorrow's Dream</span>
              <span className="block text-2xl md:text-3xl lg:text-4xl text-[#A0C4D6]">with Kerala Lottery</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Button size="lg" className="bg-gradient-to-r from-[#D4A017] to-[#B8860B] text-[#001F2D] hover:from-amber-400 hover:to-[#D4A017] rounded-full px-8 py-6 text-base font-bold shadow-[0_0_20px_rgba(212,160,23,0.4)] cursor-pointer border-none transition-all hover:scale-105">
                Buy Now
              </Button>
              <Button size="lg" variant="outline" className="rounded-full px-8 py-6 text-base border-2 border-[#005F73] text-[#A0C4D6] hover:bg-[#005F73]/40 hover:text-white font-bold backdrop-blur-md cursor-pointer shadow-[0_0_15px_rgba(0,95,115,0.2)] transition-all hover:scale-105">
                Check Results
              </Button>
            </div>
          </motion.div>
